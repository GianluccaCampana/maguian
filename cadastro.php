...
<body>
  ...
  <div style="padding-top: 5%;">
    ...
    <form id="box-cadastro" class="row g-2" action="cadastro.php" method="post">
      <div class="col-10">
      ...
      <div class="col-10">
        ...
        <input name="email"type="email" class="form-control" id="email" placeholder="Digite seu e-mail para cadastro" required>
      </div>
      <div class="col-md-5">
      ...
      <div class="col-3">
        ...
        <input name="cpf" type="text" class="form-control" placeholder="XXX.XXX.XXX-XX" id="cpf" SIZE=14 MAXLENGTH=14 required>
      </div>
      <div class="col-3">
...
function inserir(){
    ...
    echo "<h4>Email ja cadastrado </h4> ";
    mysqli_close($con);
    }
  }
?>
