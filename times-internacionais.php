...
<head>
  ...
  <title>Times Internacionais</title>
...
<body>
  <h1 style="text-align: center; padding-top: 5%;">TIMES INTERNACIONAIS</h1><BR></BR>
...
function listar()
{
  ...
  if (isset($_POST["bt1"])) {
    ...
    $sql = "SELECT * FROM `produto` WHERE categoria='INTERNACIONAIS' order by titulo";
  }
