...
<head>
  ...
  <script language="JavaScript" src="javascript/esqueciSenhaValidacao.js"></script>
                    ...
                    <form>
                      <div class="form-row">
                        <div class="form-group col-md-12">
                          ...
                          <input type="email" class="form-control" id="inputEmail"  type="email">
                        </div>
                      </div>                     
                      <button type="submit" class="btn btn-primary" id="ButtonLogin" onclick="validacao()" style="margin-top: 5px;">Entrar</button>                      
                    </form>
                  </div>
                </div>
              </div>
