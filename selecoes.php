...
<body>
  <h1 style="text-align: center; padding-top: 5%;">SELEÇÕES</h1><BR></BR>
...
function listar()
{
  ...
  if (isset($_POST["bt1"])) {
    ...
    $sql = "SELECT * FROM `produto` WHERE categoria='SELEÇÕES' order by titulo";
  }
  ...
  while ($reg  =   mysqli_fetch_array($retorno)) {
    ...
    if ($estoque > 0) {
      ...
      if ($precoPromocao >0 && $precoPromocao != null) {
        echo "<div class='col' >";
        echo  "<div class='card' >";
